      ...
      <footer className={styles.footer}>
        <div className={styles.footerContainer}>
          <div className={styles.colume}>
            ...
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi voluptatem, nam labore nesciunt eos nemo.
              Doloribus unde perferendis aut qui voluptatem cupiditate, hic, ea labore inventore dolore et nam quas?
            </p>
          </div>
          <div className={styles.colume}>
            <h3>
            ...
            <p>Los Angeles</p>
            <p>Bellflower, Canyon Country</p>
            <p>Inglewood, PIN 329022, US</p>
            <p className={styles.email}>info.losangeles@gmail.com</p>
            <h4 className={styles.callNumber}>+81 - 410 991 141</h4>
          </div>
          <div className={styles.colume}>
            <h3>
              Link
        ...
        <p className={styles.copy}>LocalHost © 2021 - All Rights Reserved</p>
      </footer>
    </div>
  );
};
